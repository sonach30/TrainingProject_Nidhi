...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row row1" id="">
			...
			<!-- COL2 STARTS -->
			<div class="col-md-2">
				<span class="glyphicon">&#xe161;</span> SIGN IN&nbsp; <span
				...
				<div class="row">
					<form action="ChangePassword" method="Post">
						...
						<div class="row">
							...
							<!-- INNER COL1 STARTS -->
							<div class="col-md-6 mrgrey">
								New Password<br> <input type="text" class="form-control"
									size="100" name="f2">
							</div>
							<!-- INNER COL1 ENDS -->
							...
							<!-- INNER COL2 STARTS -->
							<div class="col-md-6 mrgrey">
								Retype New Password<br> <input type="text"
									class="form-control" size="100" name="f3">
							</div>
							<!-- INNER COL2 ENDS -->
					...
					<%	
						if(!session.isNew())
						{
							...
							{	
					%>
				<div class="alert alert-success" role="alert">Password Change Successful
				</div>
				<% 
							}
							else if(i==-3)
				...
				<div class="row">
					...
					<form action="CustomerAccount" method="Post">
						...
						<div class="row mrgrey">
							...
							<div class="col-md-6">
								...
								<div class="radio disabled">
									<label><input type="radio" name="f6"
						...
						<div class="row mrgrey">
							...
							<!-- INNER COL2 STARTS -->
							<div class="col-md-6">
								Email<br> <input type="text" class="form-control"
									size="100">
							</div>
							<!-- INNER COL2 ENDS -->
							<br> <br>
